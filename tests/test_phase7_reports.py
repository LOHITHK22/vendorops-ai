...
def seed_extracted_record(client: TestClient) -> None:
...
def test_generate_json_and_csv_reports() -> None:
    ...
    try:
        ...
        download_response = client.get(f"/v1/reports/{json_report['report_id']}/download")
        ...
        csv_download = client.get(f"/v1/reports/{csv_report['report_id']}/download")
